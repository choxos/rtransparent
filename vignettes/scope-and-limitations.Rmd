...
such as [`rfuji`](https://github.com/choxos/rfuji), an R client for the F-UJI
FAIR assessment service, to score the findability and accessibility of the
shared resources.
