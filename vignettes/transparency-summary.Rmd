...
`is_open_code` (and `is_novelty_pred`, `is_replication_pred`).
...
Novelty and replication have no bundled accuracy estimates here, so their
corrected values are `NA`. The data/code values are reproducible benchmark
